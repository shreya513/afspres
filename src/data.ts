export const timelineData = [
  ...
  },
  {
    ...
    date: 'June 21st, 2024',
    description: "An insightful conversation with my Managing Director sponsor, Maureen, who shared her path at AFS and gave me advice on exploring and navigating my career. Maureen also introduced me to a GenAI project on our account, an area I'm interesting in exploring!",
  },
  {
    side: 'right',
    number: 10,
    ...
    date: 'June 25th, 2024',
    description: "Connected with Jay in an informative discussion on the generative AI projects on my account, including aspects of responsible AI, security, transparency with clients, and risks. It was fascinating to explore our GenAI initiatives and understand AFS' impact in this growing area.",
  },
  {
    side: 'left',
    number: 11,
