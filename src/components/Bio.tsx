    ...
    <div className="bio-container" style={{ backgroundImage: 'url(img3.JPG)', backgroundSize: "cover" }}>
      <div className=" bio-text-box">
        <p className="bio-text">
          ...
          volunteer at a local Baltimore Public School, teaching and translating for Spanish-speaking students and parents. Outsiside of school, I love hiking, baking, and 
